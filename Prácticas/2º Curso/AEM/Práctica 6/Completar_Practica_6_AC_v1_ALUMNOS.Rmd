...
donde hemos indicado que
calcule dos grupos y que realice $10$ inicializaciones al azar. 
Recordemos que el
algoritmo comienza seleccionando K centroides al azar y agrupando los datos en el grupo del centroide más
cercano. De esta forma, la solución final puede depender de esta selección al azar, por lo que es conveniente
hacer varias inicializaciones distintas. El programa nos dará el mejor resultado de esas 10 opciones. En el objeto  
