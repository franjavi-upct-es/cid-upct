...
A lo largo de la realización del informe he podido observar que era necesario descartar algunas variables para poder realizar correctamente el ACP, como por ejemplo las primeras cuatro variables (**`subject`**, **`sex`**, **`age`** y **`test_time`**) ya que eran *variables de control*.
