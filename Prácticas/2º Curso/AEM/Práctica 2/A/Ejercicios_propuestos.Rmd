...
# Comparar los R-cuadrados ajustados
cat("R-cuadrado ajustado del modelo forward: ", summary(modelo_forward)$adj.r.squared, "\n")
cat("R-cuadrado ajustado del modelo backward: ", summary(modelo_backward)$adj.r.squared, "\n")

# Comparar los AIC
cat("AIC del modelo forward: ", AIC(modelo_forward), "\n")
cat("AIC del modelo backward: ", AIC(modelo_backward), "\n")

# Comparar los BIC
cat("BIC del modelo forward: ", BIC(modelo_forward), "\n")
cat("BIC del modelo backward: ", BIC(modelo_backward), "\n")

```
El `modelo_backward` parece ser el mejor modelo, ya que tiene el R-cuadrado ajustado más alto y el AIC y BIC más bajos.
...
shapiro.test(resid(modelo_backward))
qqnorm(resid(modelo_backward))
qqline(resid(modelo_backward))
...
acf(resid(modelo_backward), main = "ACF de los residuos")

# Observaciones influyentes
influence.measures(modelo_backward)
