...
# Crear un violin plot con boxplot superpuesto
ggplot(starcraft, aes(x = "", y = apm)) +
  geom_violin(fill = "lightblue", alpha = 0.7) + # Gráfico violin
  geom_boxplot(width = 0.1, color = "darkblue", outlier.shape = NA) +
  geom_jitter(color = "orange", width = 0.2, alpha = 0.8, size = 2) +
  labs(x = "x", y = "apm")
#Fin Completar aquí
```
