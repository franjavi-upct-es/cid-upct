...
```{r}
#| echo: true
ggplot(data = df, aes(x = col2, y = col3)) +
  geom_point()
```
...
```{r}
#| echo: true
ggplot(data = df, aes(x = col2, y = col3, color = col4)) +
  geom_point()
```
...
```{r}
#| echo: true
ggplot(data = df, aes(x = col2, y = col3, color = col4, shape = col4)) +
  geom_point()
```
...
```{r}
#| echo: true
ggplot(data = df, aes(x = col2, y = col3, size = col5)) +
  geom_point()
```
...
```{r}
#| echo: true
p + geom_point(size = 3, color = "tomato") +
  labs(
    x = "col1",
    y = "col2",
    title = "Ejemplo de personalización con theme",
  ) +
  theme_minimal() +
  theme(
...
```{r}
#| echo: true
happy  <- read.csv(file = "data/happy-ESS-2002-2020.csv", sep = ";")
...
```{r}
#| echo: true
happy_spain <- subset(happy, country == "Spain")

ggplot(data = happy_spain, aes(x = year, y = mean)) +
  geom_line()
```
...
ggplot(data = happy_spain, aes(x = year, y = mean)) +
  ...
  geom_point(color = "navy", size = 2.3) +
...
```{r}
#| echo: true
happy_compare <- subset(
  happy,
  country %in% c("Total", "Germany", "France", "United Kingdom", "Spain")
)

ggplot(data = happy_compare, aes(x = year, y = mean)) +
  geom_line()
```
...
gghappiness <- ggplot(
  data = happy_compare,
  aes(x = year, y = mean, color = country, group = country)
) +
  geom_line()
...
gghappiness <- ggplot(
  data = happy_compare,
  aes(x = year, y = mean, color = country, linetype = country, group = country)
) + 
...
happy_facet  <- subset(
  happy,
  country %in% c("Spain", "France", "United Kingdom")
)

ggplot(data = happy_facet, aes(x = year, y = mean)) +
