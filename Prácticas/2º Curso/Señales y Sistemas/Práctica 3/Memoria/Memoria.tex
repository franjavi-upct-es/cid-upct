...
\end{lstlisting}
\begin{center}
\includegraphics[width=0.7\linewidth]{Imágenes/Figura13}
\end{center}
\item $x(t)=\begin{cases}
1, & t\le0.2\\
0, & \mathrm{resto}
...
\end{lstlisting}
\begin{center}
\includegraphics[width=0.7\linewidth]{Imágenes/Figura14}
\end{center}
\item $x(t)=\begin{cases}
0.5, & 0<t\le1\\
1-0.5t,&1<t\le2\\
...
\end{lstlisting}
\begin{center}
\includegraphics[width=0.7\linewidth]{Imágenes/Figura15}
\end{center}
\end{enumerate}
