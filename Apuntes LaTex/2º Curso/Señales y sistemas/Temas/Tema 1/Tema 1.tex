...
\begin{enumerate}[label=\color{red}\textbf{\arabic*)}, leftmargin=*]
	...
	\begin{itemize}[label=\color{red}\textbullet, leftmargin=*]
		...
		$\begin{rcases}
			|z|=\sqrt{\left(\frac{\sqrt{6}+\sqrt{2}}{4}\right)^2+\left(\frac{-\sqrt{6}+\sqrt{2}}{4}\right)^2}=1\\
			\varphi=\arctan\left(\dfrac{\sqrt{6}+\sqrt{2}}{4}+\dfrac{-\sqrt{6}+\sqrt{2}}{4}j\right)=-\dfrac{1}{12}\pi\equiv\dfrac{23\pi}{12}
		\end{rcases}e^{j\frac{23}{12}\pi}$
	\end{itemize}
	...
	\begin{enumerate}[label=\color{red}\alph*)]
		...
		\begin{center}
			\begin{tikzpicture}[scale=1.5]
				...
				\draw[domain=0:5, samples=150, lightblue, line width=1.2] plot (\x, {pow(0.5,\x)});
				\draw[lightblue, line width=1.2] (-2,0) -- (0,0) -- (0,1);
	...
	\begin{enumerate}[label=\color{red}\alph*)]
		...
		\begin{center}
			\includegraphics[width=0.7\linewidth]{"Temas/Tema 1/screenshot017"}
		\end{center}
		...
		\begin{center}
			\includegraphics[width=0.7\linewidth]{"Temas/Tema 1/screenshot016"}
		\end{center}
