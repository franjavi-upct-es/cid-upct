...
$\lambda=0.2$ con multiplicidad 2.
	...
	$
\begin{aligned}
			\left| \Sigma-\lambda I \right|&=\begin{vmatrix}
			\beta^{2}+\delta-\lambda & \beta & \beta \\
			\beta & 1+\delta-\lambda & 1 \\
			\beta & 1 & 1+\delta-\lambda
		\end{vmatrix}\\
		&=\beta^2\delta^2-2\beta^2\delta\lambda+\beta^2\lambda^2+\delta^3-3\delta^2\lambda+2\delta^2+3\delta\lambda^2-4\delta\lambda-\lambda^3+2\lambda^2
\end{aligned}
	$
