...
\end{lstlisting}
\begin{center}
	\includegraphics{"Temas/Tema 3/screenshot006"}
\end{center}
\begin{itemize}[label=\color{red}\textbullet, leftmargin=*]
...
Vamos a suponer que creamos una colección \texttt{blog} con los siguientes documentos
...
\end{lstlisting}
\subsubsubsection{La importancia de los índices en la eficiencia}
...
Tiempo de ejecución sin índice: \textbf{24 segundos}
...
client.close()
\end{lstlisting}
Si algún paso falla, se puede llamar siempre a \code{sessiom.abort_transaction()}, por ejemplo en un \texttt{catch} de una excepción.
\end{enumerate}