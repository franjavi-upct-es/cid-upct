  ...
  \item \lb{Determine si cada una de las siguientes señales es periódica. En caso afirmativo especifique su periodo fundamental.}
    \begin{enumerate}[label=\color{red}\textbf{\alph*)}]
      ...
      \item \db{$x[n]=3e^{j3\pi\frac{n+\frac{1}{2} }{5} } $} 
        ...
        $\omega=\dfrac{3\pi}{5}\longrightarrow N=\dfrac{2\pi}{\omega}\cdot m=\dfrac{2\pi}{\frac{3\pi}{5} }\cdot m=\dfrac{10}{3}\cdot m\longrightarrow N=10\:(m=3)$
...
\item \lb{Calcule la energía y la potencia de la señal $x[n]$ del ejercicio 28, indicando si se trata de una señal definida en energía o en potencia.}
                     ...
                     \begin{center}
                         \begin{tikzpicture}
                             ...
                             \begin{axis}[
                                 ...
                                 \addplot+[ycomb, mark=*, lightblue, line width=1.5, domain=-5:5, samples=\mysamples] {u(x+3)};
                             \end{axis}
                         \end{tikzpicture}
                     \end{center}
                     ...
                     \begin{center}
                         \begin{tikzpicture}
                             ...
                             \begin{axis}[
                                 ...
                                 \pgfmathsetmacro{\mysamples}{5-(-5)+1}
                                 \addplot+[ycomb, mark=*, lightblue, line width=1.5, domain=-5:5, samples=\mysamples] {u(x+4)*u(-x-5)};
                             \end{axis}
                         \end{tikzpicture}
                     \end{center}
            \end{itemize}
            Por lo tanto: \[
                u[n+3]-u[n+4]u[-n-5]=\begin{cases}
                    1, & n\ge -3\\
                    0, & -5\le n\le -4\\
                    0, & \text{en otro caso}
                \end{cases}
            \] 
            Esto significa que $x[n]$ es no nula únicamente para  $n\ge -3$.
        \item Expresión simplificada de $x[n]$

            Para  $n\ge -3,x[n]=\left( \dfrac{1}{2} \right) ^{2n}$. Para $n<-3 ,x[n]=0$.
            ...
            \begin{center}
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        axis lines = middle,
                        xlabel style={at={(axis cs:5,0)}, anchor=west},
                        ylabel style={at={(axis cs:0,65)}, anchor=south},
                    ]
                        \pgfmathsetmacro{\mysamples}{5-(-5)+1}
                        \addplot+[ycomb, mark=*, lightblue, line width=1.5, domain=-5:5, samples=\mysamples] {x<-3 ? 0 : (0.5)^(2*x)};
                    \end{axis}
                \end{tikzpicture}
            \end{center}
    \end{enumerate}
    ...
    La potencia promedio se calcula como: \[
        P=\lim_{N \to \infty} \dfrac{1}{2N+1}\sum_{n=-N}^{N} |x[n]|^2=\lim_{N \to \infty} \dfrac{E}{2N+1}=\dfrac{\frac{65536}{15} }{\infty}=0.
    \] 
    Por lo tanto, la señal $x[n]$ es una \textbf{señal definida en energía}. 
