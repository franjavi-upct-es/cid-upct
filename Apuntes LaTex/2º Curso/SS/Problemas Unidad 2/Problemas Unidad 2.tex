...
\end{enumerate}
  ...
  \begin{enumerate}[label=\color{red}\textbf{\alph*)}]
    \item \db{Determine y esboce $y(t)=x(t)\ast h(t)$.}
      ...
      \end{cases}
      \] 
      Esto corresponde a un triángulo con bas en $[0,1+\alpha]$, que crece linealmente en $[0,\alpha]$, se mantiene constante en $[\alpha,1]$, y decrece linealmente en $[1,1+\alpha]$.
      \begin{center}
