\begin{center}
    \Large Hoja 4: Conceptos Básicos de Series Temporales
\end{center}
    ...
    \item \lb{Los siguientes datos se corresponden  con las ventas cuatrimetrales (en miles de unidades) de una empresa que elabora latas de conserva.}
        ...
        \begin{center}
            ...
            \begin{tabular}{|p{6cm}|c|c|c|c|c|c|c|c|c|}
                ...
                Cuatrimestre: & C1 & C2 & C3 & C1 & C2 & C3 & C1 & C2 & C3\\ \hline
                Ventas (miles): & 23 & 30 & 14 & 31 & 37 & 20 & 34 & 41 & 26\\ \hline
                Tendencia ($T_t$):\linebreak Medias Móviles Orden = ¿ ? & & & & & & & & & \\ \hline
                \linebreak IBVE:& & & & & & & & & \\ \hline 
                \linebreak IVE no normalizados:& & & & & & & & & \\ \hline 
                Comp. Estacional:\linebreak $S_h=\mathrm{IVE}_h$ & & & & & & & & & \\ \hline 
