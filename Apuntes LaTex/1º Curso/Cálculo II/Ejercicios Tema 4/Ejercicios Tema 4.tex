...
\item \lb{Calcular el volumen del sólido limitado superiormente por el cilindro parabólico $z=1-y^{2}$, inferiormente por el plano $2x+3y+z+10=0$ y lateralmente por el cilindro ciruclar $x^{2}+y^{2}+x=0$.}
