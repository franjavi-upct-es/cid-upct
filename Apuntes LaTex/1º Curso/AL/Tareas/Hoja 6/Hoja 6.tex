...
$x=(x_1,x_2,x_3)\equiv(x_1,x_2,x_3,1)\equiv$ coordenadas homogéneas.
  ...
  \end{tikzcd}
    ...
    \draw[lightblue,-latex, line width=1.5] (0,0) -- (1,0) node[below right] {$e_2=(1,0)$};
    \draw[lightblue,-latex, line width=1.5] (0,0) -- (0,1) node[above right] {$e_1=(0,1)$};
    ...
    \draw[blue] (0,0.2) arc (90:135:0.2) node[midway, above] {$\alpha$};
    \draw[-latex] (0.5,0) -- (-1,-1.5) node[below] {$(-\sin(\alpha),\cos(\alpha))$};
    \end{tikzpicture}
