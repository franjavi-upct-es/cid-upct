    ...
    \item \lb{Resuelve las siguientes ecuaciones algebraicas y expresa el resultado en forma binómica:}
        \begin{enumerate}[label=\color{red}\textbf{\alph*)}]
            ...
            \item \db{$5_{-\frac{\pi}{6} }+z+4+\sqrt{2} j=6e^{-\frac{\pi}{4} j} z$} 
                ...
                $\begin{aligned}
                    5_{-\frac{\pi}{6} }+z+4+\sqrt{2} j=6e^{-\frac{\pi}{4} j} z & \longrightarrow \dfrac{5\sqrt{3} }{2}-\dfrac{5}{2}j+z+4+\sqrt{2} j=z\cdot \left( 3\sqrt{2} -3\sqrt{2} j \right)\\ 
& \longrightarrow \dfrac{8+5\sqrt{3} }{2}+\dfrac{-5+2\sqrt{2} }{2}j=z\cdot (-1+3\sqrt{2} -3\sqrt{2}j )\\ 
& \longrightarrow z=\dfrac{\frac{8+5\sqrt{3} }{2} +\frac{-5+2\sqrt{2} }{2} }{-1+3\sqrt{2} -3\sqrt{2} j}\longrightarrow z = 1.10883824361717 + 1.11594720455811 j
                \end{aligned}
                $

                $\begin{array}{l}
                    5_{-\frac{\pi}{6} }=5\cdot \left( \cos\left( -\dfrac{\pi}{6} \right) +j\sin\left( -\dfrac{\pi}{6} \right)  \right) =\dfrac{5\sqrt{3}}{2}-\dfrac{5}{2}j\\
                    6e^{-\frac{\pi}{4} j} =6\cdot \left( \cos\left( -\dfrac{\pi}{4} \right) +j\sin\left( -\dfrac{\pi}{4} \right)  \right) =3\sqrt{2} -3\sqrt{2} j
                \end{array}$
            \item \db{$2_{\frac{\pi}{3} }+j+ze^{-\frac{\pi}{3} j} =0$} 

                $2_{\frac{\pi}{3} }+j+ze^{-\frac{\pi}{3} } =0\longrightarrow 1+\sqrt{3}+j+z\cdot \left( \dfrac{1-\sqrt{3} }{2} \right) =0\longrightarrow z=-\left(\dfrac{1+\sqrt{3}+j }{\frac{1-\sqrt{3} }{2} } \right)=2\sqrt{3} +4+j+\sqrt{3} j$

                $\begin{array}{l}
                    2_{\frac{\pi}{3} }=2\cdot \left( \cos\dfrac{\pi}{3} +j\sin\dfrac{\pi}{3} \right) =1+\sqrt{3}\\
                    ze^{-\frac{\pi}{3} j}=z\cdot \left(\cos\left( -\dfrac{\pi}{3} \right) +j\sin\left( -\dfrac{\pi}{3} \right)  \right)=z\cdot \left( \dfrac{1-\sqrt{3} }{2} \right) 
                \end{array}$
            \item \db{$z+4jz=1$} 

                $z+4jz=1\longrightarrow z\cdot (1+4j)=1\longrightarrow z=\dfrac{1}{1+4j}=\dfrac{1}{1+4j}\cdot \dfrac{1-4j}{1-4j}=\dfrac{1}{17}-\dfrac{4}{17}j$
        \end{enumerate}
    \item \lb{Dados los números coomplejos $z_1=-1-j,z_2=2_{\frac{\pi}{3} },z_3=3e^{100\pi j} $, representa gráficamente los números $z_1,z_2,z_3,z_1+z_2+z_3,z_1\cdot z_2,z_1\cdot z_2\cdot z_3$.} 
        ...
        $\begin{array}{l}
            z_1=-1-j\\
            z_2=2_{\frac{\pi}{3} }=2\cdot \left( \cos\dfrac{\pi}{3}+j\sin\dfrac{\pi}{3} \right) =1+\sqrt{3} j\\
            z_3=3e^{100\pi j}=3\cdot \left( \cos(100\pi)+j\sin(100\pi) \right)  =3\\
            z_1+z_2+z_3=-1-j+1+\sqrt{3}j+3=3+(-1+\sqrt{3} ) j\\
z_1\cdot z_2= (-1-j)\cdot (1+\sqrt{3}j )=-1+\sqrt{3}-(1+\sqrt{3} ) j\\
z_1\cdot z_2\cdot z_3=(-1-j)\cdot (1+\sqrt{3}j )\cdot 3=-3+3\sqrt{3} -(3+3\sqrt{3} )j
        \end{array}$
        \begin{center}
            \includegraphics[width=0.7\textwidth]{"figures/Figure 5"}
        \end{center}
    \item \lb{Consideremos la función $f(t)=e^{-t+j_{10}t},0\le t\le 2\pi $. Se pide:}
        \begin{enumerate}[label=\color{red}\textbf{\alph*)}]
            \item \db{Dibuja de manera aproximada el conjunto $\{(\mathrm{Re}f(t), \mathrm{Im}f(t)), 0\le t\le  2\pi\} $} 
                \begin{center}
                    \includegraphics[width=0.5\textwidth]{"figures/Figure 6"}
                \end{center}
            \item \db{Dibuja de manera aproximada las funciones $\mathrm{Re}f(t),\mathrm{Im}f(t)$, y $|f(t)|$} 
                \begin{center}
                    \includegraphics[width=0.5\textwidth]{"figures/Figure 7"}
                \end{center}
        \end{enumerate}
\end{enumerate}
\end{document}
